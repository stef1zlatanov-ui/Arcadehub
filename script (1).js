(function () {
  ...
  var boards = {
    ...
    'pixel-phantom': {
      title: 'PIXEL PHANTOM — TOP SCORES',
      scores: [
        ['1', 'HLW', '73,900', 'Aug 30'],
        ['2', 'GST', '69,240', 'Aug 19'],
        ['3', 'VLE', '65,010', 'Aug 8'],
    ...
    'circuit-smash': {
      title: 'CIRCUIT SMASH — TOP SCORES',
      scores: [
        ['1', 'BZZ', '132,450', 'Aug 31'],
        ['2', 'FLX', '126,700', 'Aug 23'],
        ['3', 'WTT', '119,880', 'Aug 11'],
        ['4', 'CRK', '112,350', 'Jul 30'],
        ['5', 'MNO', '104,900', 'Jul 20'],
        ['6', 'SPK', '96,700', 'Jul 5']
      ]
    },
    'overdrive-2088': {
      title: 'OVERDRIVE 2088 — TOP SCORES',
      scores: [
        ['1', 'RDR', '221,300', 'Aug 29'],
        ['2', 'VLT', '210,850', 'Aug 17'],
        ['3', 'NTR', '198,600', 'Aug 5'],
        ['4', 'SKD', '187,400', 'Jul 25'],
        ['5', 'AXL', '175,050', 'Jul 13'],
        ['6', 'PHX', '162,900', 'Jul 1']
      ]
    }
  };
